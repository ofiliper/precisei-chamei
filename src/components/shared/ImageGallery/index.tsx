    ...
    return (
        <>
            ...
            >
                ...
                <div className={`${!showTitle && ('hidden')} flex flex-col md:flex-row justify-between items-end mb-10 gap-4`}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                            ...
                            >
                                {isUploading ? (
                                    ...
                                    <div className="flex flex-col justify-center items-center !h-[140px]"><UploadCloud size={18} /> Upload de Imagens</div>
                                )}
                            </motion.button>
                        </div>
                    ) : (
